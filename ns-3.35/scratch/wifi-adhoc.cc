...
Experiment::Experiment (std::string name): m_output (name),m_name(name)
{
                 ...
                 const WifiMacHelper &wifiMac, const YansWifiChannelHelper &wifiChannel)
{
  ...
  AnimationInterface anim(m_name+".xml");
...
int main (int argc, char *argv[])
{
  ...
  LogComponentEnable("Wifi-Adhoc", LOG_LEVEL_ALL);
  ...
  NS_LOG_DEBUG("Created Dataset of 54mb");
