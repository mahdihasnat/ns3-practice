 ...
 *
 * Based on
 *      NS-2 TORA model developed by the CMU/MONARCH group and optimized and
 *      tuned by Samir Das and Mahesh Marina, University of Cincinnati;
 *
 *      TORA-UU implementation by Erik Nordström of Uppsala University
 *      http://core.it.uu.se/core/index.php/TORA-UU
 *
...
NS_LOG_COMPONENT_DEFINE ("ToraRequestQueue");
